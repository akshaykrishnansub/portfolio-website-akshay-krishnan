  ...
  return (
    <div className='bg-slate-950 flex min-h-screen'>
      ...
      <main className='flex-1 overflow-x-auto lg:ml-52 sm:pt-10 lg:p-16'>
        ...
        <div className='text-center sm:text-sm lg:text-2xl'>
        ...
        <div className='mt-8 flex flex-wrap justify-center items-center gap-4'>
          ...
          <Link href='/Akshay_Krishnan_FullStack_Resume.pdf' download='Akshay_Krishnan_Resume.pdf' className='bg-cyan-400 rounded-3xl px-4 py-2'>⬇ Download Resume</Link>
        </div>
      </main>
    </div>
  )
